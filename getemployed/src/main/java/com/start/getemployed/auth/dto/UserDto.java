...
public class UserDto {
  ...
  public static class CreateRequest {
    ...
    public @NotBlank(message = "Email обязателен") @Email(message = "Некорректный формат email")
    String getEmail() {
      return this.email;
    }

    public @NotBlank(message = "Пароль обязателен") @Size(
        min = 8,
        message = "Пароль должен содержать минимум 8 символов") String getPassword() {
    ...
    public String toString() {
      return "UserDto.CreateRequest(email="
          + this.getEmail()
          + ", password="
          + this.getPassword()
          + ", name="
